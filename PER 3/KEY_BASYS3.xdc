...
##Pmod Header JXADC
##Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {COL[0]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {COL[0]}]
#Sch name = XA2_P
set_property PACKAGE_PIN L3 [get_ports {COL[1]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {COL[1]}]
#Sch name = XA3_P
set_property PACKAGE_PIN M2 [get_ports {COL[2]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {COL[2]}]
##Sch name = XA4_P
set_property PACKAGE_PIN N2 [get_ports {INTERRUPT}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {INTERRUPT}]
##Sch name = XA1_N
#set_property PACKAGE_PIN K3 [get_ports {INTERRUPT}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {INTERRUPT}]
###Sch name = XA2_N
#set_property PACKAGE_PIN M3 [get_ports {INTERRUPT}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {INTERRUPT}]
###Sch name = XA3_N
#set_property PACKAGE_PIN M1 [get_ports {INTERRUPT}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {INTERRUPT}]
###Sch name = XA4_N
#set_property PACKAGE_PIN N1 [get_ports {INTERRUPT}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {INTERRUPT}]
